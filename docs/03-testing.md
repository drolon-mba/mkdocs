...
| **Chaos Engineering** | Inyectar fallos en producción | Validar resiliencia real | Sistemas distribuidos críticos | Staging/Prod con % tráfico | Apagar servicios, latencia artificial, errores aleatorios | [Chaos Monkey](https://netflix.github.io/chaosmonkey/), [Gremlin](https://www.gremlin.com/) |
