...
| 🟢 | **Curly's Law** | Una función = una responsabilidad clara | Facilita testing, comprensión y reutilización | Al escribir cualquier función o método | Funciones, métodos | Nombre describe acción única, intentando que ocupe 20-30 líneas, sin efectos colaterales ocultos | [Coding Horror](https://blog.codinghorror.com/curlys-law-do-one-thing/) |
...
| 🔴 | **SoC** | Separation of Concerns - Separar responsabilidades | Facilita testing, escalabilidad, mantenimiento | En toda arquitectura | Capas, módulos | UI ≠ Lógica ≠ Persistencia. MVC, Clean Architecture. Ver también [Principios de Arquitectura](./06-arquitectura-patrones.md#principios-de-arquitectura) | [Wikipedia](https://en.wikipedia.org/wiki/Separation_of_concerns) |
...
| 🟠 | **DIP** | Dependency Inversion Principle - Depender de abstracciones | Facilita testing, intercambio de implementaciones | En dependencias entre capas | Servicios, repositorios | `UserService` depende de `IUserRepository` (interfaz), no de implementación concreta. Ver también [Principios de Arquitectura](./06-arquitectura-patrones.md#principios-de-arquitectura) | [Wikipedia](https://en.wikipedia.org/wiki/Dependency_inversion_principle) |
