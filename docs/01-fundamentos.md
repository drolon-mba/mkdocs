...
| 🔴 | **SoC** | Separation of Concerns - Separar responsabilidades | Facilita testing, escalabilidad, mantenimiento | En toda arquitectura | Capas, módulos | UI ≠ Lógica ≠ Persistencia. MVC, Clean Architecture. Ver también [Principios de Arquitectura](./04-arquitectura-patrones.md#principios-de-arquitectura) | [Wikipedia](https://en.wikipedia.org/wiki/Separation_of_concerns) |
...
| 🟠 | **DIP** | Dependency Inversion Principle - Depender de abstracciones | Facilita testing, intercambio de implementaciones | En dependencias entre capas | Servicios, repositorios | `UserService` depende de `IUserRepository` (interfaz), no de implementación concreta. Ver también [Principios de Arquitectura](./04-arquitectura-patrones.md#principios-de-arquitectura) | [Wikipedia](https://en.wikipedia.org/wiki/Dependency_inversion_principle) |
