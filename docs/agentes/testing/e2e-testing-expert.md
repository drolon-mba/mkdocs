...
description: Experto en E2E testing para automatización de UI tests, page object model y reducción de flaky tests. Usar para suites E2E con Playwright/Cypress, debugging de tests y optimización de test suites.
