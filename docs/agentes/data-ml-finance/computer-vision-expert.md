...
description: Experto en Computer Vision para object detection, segmentation e image classification. Usar para implementación de modelos de visión, data augmentation y deployment de modelos CV.
