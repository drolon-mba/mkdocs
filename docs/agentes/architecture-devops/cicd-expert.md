---
name: cicd-expert
description: Experto en CI/CD para pipelines, quality gates, deployment strategies y rollback. Usar para diseño de pipelines, automatización de deployments y estrategias de release.
