...
description: Experto en arquitectura de software para decision records (ADR), trade-offs, C4 Model y patterns arquitectónicos. Usar para decisiones arquitectónicas importantes, documentación de arquitectura y evaluación de trade-offs.
