---
name: django-expert
description: Experto en Django para arquitectura monolítica, ORM avanzado, Django REST Framework y background tasks con Celery. Usar para aplicaciones Django complejas, optimización de queries y diseño de modelos.
