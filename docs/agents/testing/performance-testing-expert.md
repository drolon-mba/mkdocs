...
description: Experto en performance testing para load, stress, spike tests y benchmarks. Usar para planes de carga, identificación de bottlenecks y optimización de performance.
