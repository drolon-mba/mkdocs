---
name: bdd-expert
description: Experto en BDD para criterios de aceptación, escenarios Given-When-Then y Cucumber/Gherkin. Usar para escribir features en Gherkin, implementar step definitions y colaboración con stakeholders.
