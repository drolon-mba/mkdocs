---
name: express-expert
description: Experto en Express.js para APIs REST, middlewares, error handling y security. Usar para arquitectura de aplicaciones Express, implementación de middlewares custom y configuración de seguridad.
