---
name: nestjs-expert
description: Experto en NestJS para arquitectura modular, dependency injection, decorators, guards e interceptors. Usar para aplicaciones enterprise con NestJS, diseño de módulos y implementación de arquitectura hexagonal.
