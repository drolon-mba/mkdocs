---
name: fastapi-expert
description: Experto en FastAPI para APIs rápidas, validación con Pydantic, async endpoints y dependency injection. Usar para desarrollo de APIs REST modernas, documentación OpenAPI y optimización de performance.
