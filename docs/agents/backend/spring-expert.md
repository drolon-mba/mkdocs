---
name: spring-expert
description: Experto en Spring Boot y ecosistema Spring para microservicios, seguridad OAuth2/JWT y reactive programming. Usar para arquitectura de microservicios, configuración de seguridad y desarrollo de APIs REST.
