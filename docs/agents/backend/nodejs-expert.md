---
name: nodejs-expert
description: Experto en Node.js para event loop, async patterns, streams y performance optimization. Usar para debugging de memory leaks, optimización de I/O y arquitectura de aplicaciones Node.js.
