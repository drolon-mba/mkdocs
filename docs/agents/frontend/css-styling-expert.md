...
description: Experto en CSS para layouts (Flexbox, Grid), responsive design, animations y arquitectura CSS. Usar para sistemas de diseño, theming, optimización de CSS y debugging de layout issues.
