---
name: diagram-expert
description: Experto en Diagrams para diagramas de arquitectura, flujo, secuencia y clases con Mermaid, PlantUML y C4. Usar para visualizar arquitectura, flujos de datos y diseño de sistemas.
