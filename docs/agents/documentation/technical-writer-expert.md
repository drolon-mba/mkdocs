...
description: Experto en Technical Writing para manuales, API docs, tutorials y style guides. Usar para redacción de documentación técnica, creación de tutoriales y establecimiento de style guides.
