---
name: nlp-expert
description: Experto en NLP para text processing, embeddings, fine-tuning LLMs y RAG. Usar para procesamiento de texto, clasificación, fine-tuning de modelos y sistemas de Q&A.
