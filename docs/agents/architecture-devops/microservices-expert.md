...
description: Experto en microservicios para bounded contexts, comunicación inter-servicios, resiliencia y service mesh. Usar para diseño de arquitectura de microservicios, patrones de comunicación y estrategias de resiliencia.
