...
description: Experto en observability para instrumentación (metrics, logs, traces), alerting y SLOs. Usar para implementar monitoring, crear dashboards y configurar alerting strategies.
