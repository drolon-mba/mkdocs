...
description: Experto en security para OWASP Top 10, SAST/DAST, threat modeling (STRIDE) y security reviews. Usar para security audits, threat modeling y implementación de security best practices.
