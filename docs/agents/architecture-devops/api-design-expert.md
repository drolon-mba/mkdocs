...
description: Experto en diseño de APIs para OpenAPI, AsyncAPI, REST, GraphQL y gRPC. Usar para diseño de APIs, versionado, documentación y contratos entre servicios.
